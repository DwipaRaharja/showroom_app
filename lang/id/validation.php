...
return [
    ...
    'attributes' => [
        ...
        // Showroom Application Attributes
        'car_id' => 'mobil',
        ...
        'disbursement_estimated_date' => 'estimasi tanggal pencairan',
        'disbursement_actual_date' => 'tanggal realisasi pencairan',
        'deal_price' => 'harga kesepakatan',
        'down_payment' => 'uang muka / DP',
        'trade_in_price' => 'nilai mobil tukar tambah',
        'trade_in_brand' => 'merek mobil tukar tambah',
        'trade_in_car_name' => 'nama unit tukar tambah',
        'trade_in_license_plate' => 'plat nomor tukar tambah',
        ...
        'trade_in_notes' => 'catatan unit tukar tambah',
        'finance_amount' => 'pokok pembiayaan leasing',
        'leasing_bonus' => 'bonus komisi leasing',
        'selling_price' => 'harga jual',
        'license_plate' => 'plat nomor',
        'chassis_number' => 'nomor rangka',
        'engine_number' => 'nomor mesin',
        'processor_name' => 'nama pelaksana / biro jasa',
    ...
    'custom' => [
        'started_at' => [
            'before_or_equal' => ':Attribute tidak boleh melebihi tanggal hari ini.',
            'required' => ':Attribute wajib diisi.',
        ...
        'occurred_at' => [
            'before_or_equal' => ':Attribute tidak boleh melebihi waktu saat ini.',
        ],
        'estimated_completion_date' => [
            'after_or_equal' => ':Attribute harus berupa tanggal yang sama atau setelah tanggal mulai.',
        ],
    ],
    'values' => [
        'started_at' => [
